...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"uniappMusic","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*******************************************************!*\
  !*** D:/桌面/前端学习/项目学习/uniapp学习/uniappMusic/pages.json ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!***************************************************************!*\
  !*** D:/桌面/前端学习/项目学习/uniapp学习/uniappMusic/common/js/utils.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 40 */
/*!**********************************************************!*\
  !*** D:/桌面/前端学习/项目学习/uniapp学习/uniappMusic/apis/index.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 41 */
/*!********************************************************************!*\
  !*** D:/桌面/前端学习/项目学习/uniapp学习/uniappMusic/untils/request/index.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _request = _interopRequireDefault(__webpack_require__(/*! ./request */ 45));
/* const baseUrl =
...
var reqInterceptor = /*#__PURE__*/function () {
  ...
  return function reqInterceptor(_x) {
    return _ref.apply(this, arguments);
  };
}();
var resInterceptor = /*#__PURE__*/function () {
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            conf = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : {};
            uni.hideLoading();
  ...
  return function resInterceptor(_x2) {
...
function _responseLog(res) {
  ...
  var describe = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
/* 45 */
/*!**********************************************************************!*\
  !*** D:/桌面/前端学习/项目学习/uniapp学习/uniappMusic/untils/request/request.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23));
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _common = __webpack_require__(/*! ./common */ 46);
// 一些请求方面的封装
var Request = /*#__PURE__*/function () {
  function Request() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var reqInterceptor = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    var resInterceptor = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    var successHandler = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    var failHandler = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    var completeHandler = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
  ...
  (0, _createClass2.default)(Request, [{
    key: "request",
    value: function () {
      var _request = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(options) {
        var successHandler,
          failHandler,
          completeHandler,
          task,
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                successHandler = _args.length > 1 && _args[1] !== undefined ? _args[1] : null;
                failHandler = _args.length > 2 && _args[2] !== undefined ? _args[2] : null;
                completeHandler = _args.length > 3 && _args[3] !== undefined ? _args[3] : null;
                task = options.task || false;
                type = options.type || "request"; // 删除配置任务
                config = null;
                _context.prev = 6;
                _context.next = 9;
                return (0, _common.requestConfig)(this, options, successHandler, failHandler, completeHandler);
              case 9:
              ...
              case 17:
                ...
                return _context.abrupt("return", uni.request(config));
              case 26:
                if (!(type === "upload")) {
                  _context.next = 30;
                  break;
                }
                return _context.abrupt("return", uni.uploadFile(config));
              case 30:
                return _context.abrupt("return", uni.downloadFile(config));
              case 31:
...
/* 46 */
/*!*********************************************************************!*\
  !*** D:/桌面/前端学习/项目学习/uniapp学习/uniappMusic/untils/request/common.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 44));
// 公共的一些拦截
function requestConfig(_x, _x2) {
  return _requestConfig.apply(this, arguments);
}
function _requestConfig() {
  _requestConfig = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(ins, options) {
    var successHandler,
      fallHandler,
      completeHandler,
      config,
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            successHandler = _args.length > 2 && _args[2] !== undefined ? _args[2] : null;
            fallHandler = _args.length > 3 && _args[3] !== undefined ? _args[3] : null;
            completeHandler = _args.length > 4 && _args[4] !== undefined ? _args[4] : null;
            // 基础配置 请求头和基本路劲
            ...
            _context.prev = 8;
            _context.next = 11;
            return ins.requestInterceptor(Object.assign({}, options, config));
          case 11:
            _cg = _context.sent;
            _context.next = 17;
            break;
          ...
          case 17:
            if (!(!_cg || (0, _typeof2.default)(_cg) !== "object")) {
              _context.next = 19;
              break;
            }
            return _context.abrupt("return", false);
          ...
          case 22:
            type = options.type || "request"; //   配置属性项的属性细节，不直接进行配置，移除不需要的属性
            if (type === "request") {
